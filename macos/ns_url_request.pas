...
type
  ...
  public
    ...
    function SendAndReceive(var AResponse : string) : Boolean; overload;
    function PostForm(const FormFields : string;
                        var AResponse  : string) : Boolean; overload;
  end;
...
function TNSHTTPSendAndReceive.SendAndReceive(var AResponse : string) : Boolean;
 {Send HTTP request to current Address URL, returning downloaded data 
